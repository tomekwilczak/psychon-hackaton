...
- [ ] 3.7 H16 — Powiadomienia, dzwonek i e-maile symulowane · Właściciel: `@_____` · Status: `GOTOWE`; weryfikacja: kryteria ★ i testy H16 przechodzą, wiadomości trafiają wyłącznie do Mailpit, istnieje `DEMO/H16.md`.
...
- [ ] 3.9 H19 — Pulpit administracyjny i ustawienia edycji · Właściciel: `@_____` · Status: `GOTOWE`; weryfikacja: kryteria ★ i testy H19 przechodzą, istnieje `DEMO/H19.md`.
- [ ] 3.10 H21 — Onboarding „Zacznij tutaj” · Właściciel: `@_____` · Status: `GOTOWE`; weryfikacja: kryteria ★ i testy H21 przechodzą, istnieje `DEMO/H21.md`.
...
- [ ] 4.6 H11 — Dziennik stażu i akceptacje · Właściciel: `@_____` · Status: `GOTOWE`; weryfikacja: kryteria akceptacji i testy H11 przechodzą, istnieje `DEMO/H11.md`.
...
- [ ] 5.1 H14 — Dokumenty generowane z profilu · Właściciel: `@_____` · Status: `GOTOWE`; weryfikacja: kryteria akceptacji i testy H14 przechodzą, istnieje `DEMO/H14.md`.
