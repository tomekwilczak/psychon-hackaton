...
- [ ] 9.3 Uruchomić `npm run lint` i `npm run build` oraz manualny przegląd obu ekranów klawiaturą i mobile; weryfikacja: komendy i przegląd są zielone, a stany ładowania, pusty, błędu, sukcesu i trwających akcji są udokumentowane.
